          ...
          <li v-for="(i,index) in show_list" :id="index">
            ...
            <div v-for="(j,idx) in i.foods" class="menu_detail_list">
              ...
              <div class="menu_detail_footer">
                <p class="food_price" v-if="j.specfoods[0]"><span>￥</span><span style="font-size: .35rem">{{j.specfoods[0].price}}</span><span style="padding-left: .1rem;color: #666;">{{j.specfoods.length>1?'起':''}}</span></p>
